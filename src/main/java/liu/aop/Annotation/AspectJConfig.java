...
public class AspectJConfig implements Ordered{
	...
	*/
	...
	public Object  bicycleAround(ProceedingJoinPoint pjp)   {
		Object result=null;
	...
	//定义异常通知
	@AfterThrowing(pointcut="bicyclePointcut(brann,manufactorr)",
			argNames="brann,manufactorr,exception",
			throwing="exception")
	public void bicycleAfterThrowing(Object brann,Object manufactorr,BlacklistException exception) {  
		System.out.println("\n调用代理类方法：bicycleAfterThrowing()  ");
		System.out.println("该共享单车太重，不好骑！"+"  ");
	}
